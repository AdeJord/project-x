    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-700 to-indigo-600 text-white pt-20">
        <div className="max-w-5xl mx-auto py-16 px-6">
          ...
          <p className="text-lg mb-6">
            We focus on small and new businesses, particularly those who rely heavily on paperwork and manual data duplication. These outdated methods not only pose a risk of losing important information but also require expensive storage solutions. If you're ready to streamline your business processes and cut down on unnecessary expenses, we’re here to help.
          </p>
          <p className="text-lg mb-6">
