      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-700 to-indigo-600 text-white pt-20 relative">
        ...
        <div className="relative z-10 max-w-5xl mx-auto py-12 px-6">
          <h1 className="text-5xl font-bold mb-6 text-center tracking-tight">
            About <span className="text-yellow-400">Project-X</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            ...
            <div className="bg-white text-blue-900 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-lg mb-4 leading-relaxed">
                We run <strong>Project-X</strong> with a simple, friendly approach: we do our very best to help businesses thrive.
              </p>
              <p className="text-lg leading-relaxed">
          ...
          <div className="mt-16 p-8 bg-indigo-700 bg-opacity-90 rounded-lg shadow-md">
            ...
            <p className="text-lg mb-6 leading-relaxed">
              At <strong>Project-X</strong>, we leverage AI-driven tools for code generation, allowing us to create scalable, efficient applications more quickly. This use of AI ensures that we follow industry best practices while writing code, without sacrificing quality.
            </p>
            <p className="text-lg mb-6 leading-relaxed">
